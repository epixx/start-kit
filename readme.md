...
npm run eslint    # проверить js-файлы
```

Перед коммитом происходит автопроверка файлов. Если проверка выявила ошибки, они будут показаны в терминале и коммит не ьудет сделан. Исправьте ошибки и закомитьте.
